...
tellraw @s [{"text":"  カスタマイズできます。レアモブ・準レアモブ","color":"white"}]
tellraw @s [{"text":"  機能も搭載。","color":"white"}]
tellraw @s ""
...
tellraw @s [{"text":"  "},{"text":"[準レアモブ設定]","color":"yellow","clickEvent":{"action":"suggest_command","value":"/function spmob:command/set_mob_semi_rare {mob:\"minecraft:pig\"}"},"hoverEvent":{"action":"show_text","contents":"クリックしてコマンドを編集"}},{"text":" - 準レアモブを設定","color":"gray"}]
tellraw @s [{"text":"  "},{"text":"[準レアNBT設定]","color":"yellow","clickEvent":{"action":"suggest_command","value":"/function spmob:command/set_nbt_semi_rare {nbt:''}"},"hoverEvent":{"action":"show_text","contents":"クリックしてコマンドを編集"}},{"text":" - 準レアモブのNBTを設定","color":"gray"}]
tellraw @s [{"text":"  "},{"text":"[準レア確率設定]","color":"yellow","clickEvent":{"action":"suggest_command","value":"/function spmob:command/set_semi_rare_probability {value:5}"},"hoverEvent":{"action":"show_text","contents":"クリックしてコマンドを編集"}},{"text":" - 準レア出現確率(0-100%)を設定","color":"gray"}]
